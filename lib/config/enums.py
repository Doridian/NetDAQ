...
class DAQCommand(Enum):
    ...
    GET_LASTREADING = 0x00000065
    SCANS_TRIGGER = 0x00000066
    START = 0x00000067
    STOP = 0x00000068
    GET_TIME = 0x00000069
    SET_TIME = 0x0000006A
